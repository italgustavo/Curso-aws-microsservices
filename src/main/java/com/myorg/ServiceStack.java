...
public class ServiceStack extends Stack{
    ...
    public ServiceStack(Construct scope, String id, Cluster cluster) {
        this(scope, id, (StackProps)null, cluster);
    }

    public ServiceStack(Construct scope, String id, StackProps props, Cluster cluster) {
                ...
                ApplicationLoadBalancedFargateService.Builder.create(this, "ALB01")
                        ...
                        .taskImageOptions(
                                ApplicationLoadBalancedTaskImageOptions.builder()
                                        ...
                                        .image(ContainerImage.fromRegistry("italgustavo/aws_project01:1.1.0"))
                                        .containerPort(8080)
